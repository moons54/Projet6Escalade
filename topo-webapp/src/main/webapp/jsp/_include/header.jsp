        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <s:a class="nav-link" action="topo_liste">Gestion topo<span class="sr-only">(current)</span></s:a>
                </li>
                <li class="nav-item active">
                ...
                <s:if test="%{#session.user.nom=='moons'}">
                    <li class="nav-item active">
                    <s:a class="nav-link" action="utilisateur_list">Gestion des utilisateurs <span class="sr-only">(current)</span></s:a>
                    </li>

                    <li class="nav-item active">
                    <s:a class="nav-link" action="topreservable_list">Location de Topo<span class="sr-only">(current)</span></s:a>
                    </li>
                    <li class="nav-item active">
                    <s:a class="nav-link" action="recherche_new">Recherche multicritere<span class="sr-only">(current)</span></s:a>
                    </li>
            ...
            <s:if test="#session.user">
                <h2> <s:property value="#session.user.identifiant"/></h2>
            </s:if>
        </div>
    </div>
</div>
